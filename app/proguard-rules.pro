...
-keep class com.cct.music.lite.models.PersistQueue { *; }
-keep class com.cct.music.lite.models.PersistPlayerState { *; }
-keep class com.cct.music.lite.models.QueueData { *; }
-keep class com.cct.music.lite.models.QueueType { *; }
-keep class com.cct.music.lite.playback.queues.** { *; }
